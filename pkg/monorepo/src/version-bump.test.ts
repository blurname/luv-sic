...
test('version-bump', ()=>{
  ...
  strictEqual(versionBumpBranch({branch:'master',_versionStr:'1.0.0',digit:'minor'}), '1.1.0')
  strictEqual(versionBumpBranch({branch:'master',_versionStr:'1.0.0',digit:'major'}), '2.0.0')

  strictEqual(versionBumpBranch({branch:'master',_versionStr:'1.0.53',digit:'patch'}), '1.0.54')

  strictEqual(versionBumpBranch({branch:'bltest',_versionStr:'1.0.0',digit:'patch'}), '1.0.0-bltest.0')
  ...
  strictEqual(versionBumpBranch({branch:'bl/abcd',_versionStr:'1.0.0',digit:'patch'}), '1.0.0-blabcd.0')

  strictEqual(versionBumpBranch({branch:'bl/abcd-efg',_versionStr:'1.0.0',digit:'patch'}), '1.0.0-blabcdefg.0')
