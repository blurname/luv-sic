module.exports = {
  ...
  rules: {
    ...
    'array-bracket-spacing': ['error', 'never'], // 'array-bracket-spacing': [ 'error', 'never' ], // EDIT
    ...
    'computed-property-spacing': ['error', 'never', { enforceForClassMembers: true }], // 'computed-property-spacing': [ 'error', 'never', { enforceForClassMembers: true } ], // EDIT
