...
class createObjectDeepUpdate {
    pathMap = new Map();
    keyPath = '';
    findObjectPathByTargetKey = (obj, key, path) => {
    ...
    generatePathMap = (objs, keyTarget) => {
        objs.forEach((obj) => {
            if (obj[keyTarget] !== undefined)
                this.keyPath = keyTarget;
            else
